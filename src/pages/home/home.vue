<template>
  <div id="home_page">
    ...
    <!-- 隔板结束 -->
    <!-- 主体开始 -->
    <div class="swiper-content" style="overflow:hidden;">
...
<script type="text/javascript">
  ...
  import partVideo from './parts/partVideo';
  ...
  export default {
    ...
    mounted() {
      // let param = {
      //   phone: 13160674351,
      //   password: '5dixiachengshiwo'
      // }
      // getLogincellphoneResource(param).then(res => {
      //   console.log(res);
      // })
      this.initData();
      this.$swiper = new Swiper('.swiper-content', {
        ...
        on: {
          slideChangeTransitionStart: () => {
            this.navNum = this.$swiper.activeIndex;
            console.log(this);
          },
        },
      })
